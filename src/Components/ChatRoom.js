...
function ChatRoom({
  ...
  console.log(
    `❗❗❗ 방 입장 userNickName : ${userNickName}, userToken : ${userToken}, userSessionId : ${userSessionId}`
  );
  ...
  const connection = () => {
    ...
    //세션 연결
    mySession
      .connect(userToken, { clientData: userNickName })
      .then(async () => {
        ...
        OV.getUserMedia({
          ...
          let publisher = OV.initPublisher(userNickName, {
